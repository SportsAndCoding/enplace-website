...
export default function Effect() {
    ...
    <div class="effect__container">
      ...
      <!-- Methodology -->
      <details class="effect__methodology">
        <summary class="effect__methodology-summary">
          <span>Methodology & Data Sources</span>
          <span class="effect__methodology-hint">Click to expand</span>
        </summary>
        <div class="effect__methodology-body">
          <p>
            Results represent 100 restaurants across 12 industry segments. Pre-adoption turnover
            baselines were calibrated against published industry benchmarks using binary search to find
            daily quit probabilities that reproduce known annual turnover rates within ±2 percentage points.
          </p>
          <p>
            The model uses a two-bucket approach: new hires (tenure &lt; 90 days) experience quit
            rates approximately 5× higher than established staff — consistent with published research
            on the 90-day cliff in hospitality retention.
          </p>
          <p>
            Post-adoption rates reflect the annualized quit count from the adoption period forward,
            eliminating measurement contamination from the rolling 365-day window.
          </p>
          <p>
            Individual restaurant results vary. With 8–9 locations per segment, some restaurants
            experience cascade events that drive their rates above average. This variance is expected
            and reflects the real-world distribution operators experience annually.
          </p>
          <p class="effect__methodology-sources">
            <strong>Sources:</strong> National Restaurant Association, Cornell Hotel School, Black Box
