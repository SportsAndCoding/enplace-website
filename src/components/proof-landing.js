    ...
    <section class="proof-hero">
      ...
      <nav class="proof-nav">
        ...
        <div class="proof-nav__actions">
          <a href="https://app.proof.en-place.ai/login" class="proof-nav__login">Login</a>
          <a href="https://app.proof.en-place.ai/register" class="btn-proof-primary btn-proof-primary--nav">Get Access</a>
        </div>
      </nav>
      ...
      <div class="proof-hero__content">
        ...
        <div class="proof-hero__cta-stack">
          <a href="https://app.proof.en-place.ai/register" class="btn-proof-primary">
    ...
    <section class="proof-sec proof-sec--dark" id="use-cases">
      <div class="proof-sec__inner">
        ...
        <div class="proof-usecases">
          ...
          <div class="proof-usecases__card">
            ...
            <div class="proof-usecases__footer">
              ...
              <a href="https://app.proof.en-place.ai/register" class="btn-proof-primary btn-proof-primary--sm">Get Access</a>
            </div>
          </div>
          ...
          <div class="proof-usecases__card">
            ...
            <div class="proof-usecases__footer">
              ...
              <a href="https://app.proof.en-place.ai/register" class="btn-proof-primary btn-proof-primary--sm">Buy Credits</a>
            </div>
          </div>
        ...
        <div class="proof-credit-callout">
          ...
          <a href="https://app.proof.en-place.ai/register" class="btn-proof-primary" style="white-space:nowrap;flex-shrink:0;">Buy Credits &nbsp;→</a>
        </div>
    ...
    <section class="proof-cta-band">
      <div class="proof-cta-band__inner">
        ...
        <div class="proof-cta-band__btns">
          <a href="https://app.proof.en-place.ai/register" class="btn-proof-primary">Get Full Access &nbsp;→</a>
